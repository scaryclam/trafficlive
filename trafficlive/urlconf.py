urls = {
    ...
    "get_employee": {"method": "GET", "url": "/staff/employee/{id}"},
    ...
    "get_department": {"method": "GET", "url": "/staff/department/{id}"},
    ...
    "get_timeentry": {"method": "GET", "url": "/timeentries/{id}"},
    ...
    "get_crm_employee": {"method": "GET", "url": "/crm/employee/{id}"},
    "update_crm_employee": {"method": "POST", "url": "/crm/employee"},
    "add_crm_employee": {"method": "PUT", "url": "/crm/employee"},
    "get_listitems": {"method": "GET", "url": "/listitem/{type}"},
    "get_listitem": {"method": "GET", "url": "/listitem/{type}/{id}"},
    "update_listitem": {"method": "POST", "url": "/listitem/{type}"},
    "add_listitem": {"method": "PUT", "url": "/listitem/{type}"},
    "delete_listitem": {"method": "DELETE", "url": "/listitem/{type}/{id}"},
    "get_taxtypes": {"method": "GET", "url": "/taxtype"},
    "get_taxtype": {"method": "GET", "url": "/taxtype/{id}"},
    "update_taxtype": {"method": "POST", "url": "/taxtype"},
    "add_taxtype": {"method": "PUT", "url": "/taxtype"},
    "delete_taxtype": {"method": "DELETE", "url": "/taxtype/{id}"},
    "get_application_countries": {"method": "GET", "url": "/application/country"},
    "get_application_country": {"method": "GET", "url": "/application/country/{code}"},
}
